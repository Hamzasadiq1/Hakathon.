    ...
    <div className="bg-[#F2F0FF] w-full h-auto flex flex-col lg:flex-row items-center justify-around p-4 lg:p-10">
      ...
      <div className="relative mt-12 lg:mt-0">
        ...
        <Image
          ...
          width={900}
          height={900}
          className="absolute top-[25px] md:top-[30px] lg:top-[50px] right-12 lg:right-20 w-[220px] h-[220px] md:w-[330px] md:h-[330px] xl:w-[430px] xl:h-[430px] pl-12 rounded-full"
        />
